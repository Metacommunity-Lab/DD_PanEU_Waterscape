##### ##### ##### #####  ENSAMBLE CENTRALIDAD EUROPA ##### ##### ##### ##### 
setwd("~/Documents/Analisis_Datos/A_H2020_Networks/EUROPA_EN_10X10")
load("~/Documents/Analisis_Datos/A_H2020_Networks/EUROPA_EN_10X10/Paisajes_Ensamble_Europa.RData")
save.image("~/Documents/Analisis_Datos/A_H2020_Networks/EUROPA_EN_10X10/Paisajes_Ensamble_Europa.RData")

##### MATRIZ COMPLETA DIFERENCIANDO POR CUERPO DE AGUA (EF(1).T(2).P(3)) Y TIERRA (0)
unique(M.final.UK$ISO3_CODE);dim(M.final.UK)
unique(M.final.SWE$ISO3_CODE); dim(M.final.SWE)
unique(M.final.ESP.PRT$ISO3_CODE); dim(M.final.ESP.PRT) #### ojo UTM_Y ESTA MAL
...
##### MATRIZ COMPLETA AGUA (EF(1).T(2).P(3) == 100 ) Y TIERRA ((EF(1).T(2).P(3) == 0)
